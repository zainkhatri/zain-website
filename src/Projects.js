          ...
          >
            ...
            <div className="project">
              <div className="project-content">
                <h3 className="project-title" onClick={() => toggleProject('rover')}>
            ...
            <div className="project">
              <div className="project-content">
                <h3 className="project-title" onClick={() => toggleProject('exoskeleton')}>
